...
type FeedPermissionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	IdentityDescriptorRef *v1.NamespacedReference `json:"identityDescriptorRef,omitempty" tf:"-"`

	// Selector for a Group in security to populate identityDescriptor.
	// +kubebuilder:validation:Optional
	IdentityDescriptorSelector *v1.NamespacedSelector `json:"identityDescriptorSelector,omitempty" tf:"-"`
