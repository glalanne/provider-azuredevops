...
func (mg *TeamMembers) GetTerraformResourceType() string {
	return "azuredevops_team_members"
}
...
func (tr *TeamMembers) GetObservation() (map[string]any, error) {
...
func (tr *TeamMembers) SetObservation(obs map[string]any) error {
...
func (tr *TeamMembers) GetParameters() (map[string]any, error) {
...
func (tr *TeamMembers) SetParameters(params map[string]any) error {
...
// GetInitParameters of this TeamMembers
func (tr *TeamMembers) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TeamMembers
func (tr *TeamMembers) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
