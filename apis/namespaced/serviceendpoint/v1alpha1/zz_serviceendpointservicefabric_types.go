...
type CertificateInitParameters struct {
	...
	// Password for the certificate.
	ClientCertificatePasswordSecretRef *v1.LocalSecretKeySelector `json:"clientCertificatePasswordSecretRef,omitempty" tf:"-"`

	// Base64 encoding of the cluster's client certificate file.
	// Base64 encoding of the cluster's client certificate file.
	ClientCertificateSecretRef v1.LocalSecretKeySelector `json:"clientCertificateSecretRef" tf:"-"`
