...
type ServiceendpointBlackDuckInitParameters struct {
...
type ServiceendpointBlackDuckObservation struct {
...
type ServiceendpointBlackDuckParameters struct {
...
// ServiceendpointBlackDuckSpec defines the desired state of ServiceendpointBlackDuck
type ServiceendpointBlackDuckSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ServiceendpointBlackDuckParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ServiceendpointBlackDuckInitParameters `json:"initProvider,omitempty"`
}

// ServiceendpointBlackDuckStatus defines the observed state of ServiceendpointBlackDuck.
type ServiceendpointBlackDuckStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ServiceendpointBlackDuckObservation `json:"atProvider,omitempty"`
}
...
// ServiceendpointBlackDuck is the Schema for the ServiceendpointBlackDucks API. Manages a Black Duck Detect service endpoint within Azure DevOps organization.
...
type ServiceendpointBlackDuck struct {
	...
	Spec   ServiceendpointBlackDuckSpec   `json:"spec"`
	Status ServiceendpointBlackDuckStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ServiceendpointBlackDuckList contains a list of ServiceendpointBlackDucks
type ServiceendpointBlackDuckList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ServiceendpointBlackDuck `json:"items"`
}

// Repository type metadata.
var (
	ServiceendpointBlackDuck_Kind             = "ServiceendpointBlackDuck"
	ServiceendpointBlackDuck_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ServiceendpointBlackDuck_Kind}.String()
	ServiceendpointBlackDuck_KindAPIVersion   = ServiceendpointBlackDuck_Kind + "." + CRDGroupVersion.String()
	ServiceendpointBlackDuck_GroupVersionKind = CRDGroupVersion.WithKind(ServiceendpointBlackDuck_Kind)
)

func init() {
	SchemeBuilder.Register(&ServiceendpointBlackDuck{}, &ServiceendpointBlackDuckList{})
}
