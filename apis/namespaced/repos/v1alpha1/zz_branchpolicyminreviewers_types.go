...
type BranchPolicyMinReviewersInitParameters struct {
	...
	Settings *BranchPolicyMinReviewersSettingsInitParameters `json:"settings,omitempty" tf:"settings,omitempty"`
}
...
type BranchPolicyMinReviewersObservation struct {
	...
	// A settings block as defined below.. This block must be defined exactly once.
	Settings *BranchPolicyMinReviewersSettingsObservation `json:"settings,omitempty" tf:"settings,omitempty"`
}
...
type BranchPolicyMinReviewersParameters struct {
	...
	// A settings block as defined below.. This block must be defined exactly once.
	// +kubebuilder:validation:Optional
	Settings *BranchPolicyMinReviewersSettingsParameters `json:"settings,omitempty" tf:"settings,omitempty"`
}

type BranchPolicyMinReviewersSettingsInitParameters struct {
	...
	Scope []BranchPolicyMinReviewersSettingsScopeInitParameters `json:"scope,omitempty" tf:"scope,omitempty"`
...
type BranchPolicyMinReviewersSettingsObservation struct {
	...
	// A scope block as defined below. Controls which repositories and branches the policy will be enabled for. This block must be defined at least once.
	Scope []BranchPolicyMinReviewersSettingsScopeObservation `json:"scope,omitempty" tf:"scope,omitempty"`

	// Allow requesters to approve their own changes. Defaults to false.
	SubmitterCanVote *bool `json:"submitterCanVote,omitempty" tf:"submitter_can_vote,omitempty"`
}

type BranchPolicyMinReviewersSettingsParameters struct {
	...
	// A scope block as defined below. Controls which repositories and branches the policy will be enabled for. This block must be defined at least once.
	// +kubebuilder:validation:Optional
	Scope []BranchPolicyMinReviewersSettingsScopeParameters `json:"scope" tf:"scope,omitempty"`
...
type BranchPolicyMinReviewersSettingsScopeInitParameters struct {
...
type BranchPolicyMinReviewersSettingsScopeObservation struct {
...
type BranchPolicyMinReviewersSettingsScopeParameters struct {
...
// BranchPolicyMinReviewersSpec defines the desired state of BranchPolicyMinReviewers
type BranchPolicyMinReviewersSpec struct {
	...
	// autoscaler.
	InitProvider BranchPolicyMinReviewersInitParameters `json:"initProvider,omitempty"`
}

// BranchPolicyMinReviewersStatus defines the observed state of BranchPolicyMinReviewers.
...
// BranchPolicyMinReviewers is the Schema for the BranchPolicyMinReviewerss API. Manages a minimum reviewer branch policy within Azure DevOps project.
...
// BranchPolicyMinReviewersList contains a list of BranchPolicyMinReviewerss
...
var (
	BranchPolicyMinReviewers_Kind             = "BranchPolicyMinReviewers"
	BranchPolicyMinReviewers_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BranchPolicyMinReviewers_Kind}.String()
	BranchPolicyMinReviewers_KindAPIVersion   = BranchPolicyMinReviewers_Kind + "." + CRDGroupVersion.String()
	BranchPolicyMinReviewers_GroupVersionKind = CRDGroupVersion.WithKind(BranchPolicyMinReviewers_Kind)
)
