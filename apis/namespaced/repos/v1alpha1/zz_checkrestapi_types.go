...
type CheckRestAPIInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	VariableGroupNameRef *v1.NamespacedReference `json:"variableGroupNameRef,omitempty" tf:"-"`

	// Selector for a VariableGroup in pipelines to populate variableGroupName.
	// +kubebuilder:validation:Optional
	VariableGroupNameSelector *v1.NamespacedSelector `json:"variableGroupNameSelector,omitempty" tf:"-"`
}
