...
// GetInitParameters of this GitRepository
func (tr *GitRepository) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this GitRepository
func (tr *GitRepository) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
