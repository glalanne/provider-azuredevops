...
type BranchPolicyBuildValidationSettingsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-azuredevops/apis/namespaced/pipelines/v1alpha1.BuildDefinition
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	BuildDefinitionIDRef *v1.NamespacedReference `json:"buildDefinitionIdRef,omitempty" tf:"-"`

	// Selector for a BuildDefinition in pipelines to populate buildDefinitionId.
	// +kubebuilder:validation:Optional
	BuildDefinitionIDSelector *v1.NamespacedSelector `json:"buildDefinitionIdSelector,omitempty" tf:"-"`
