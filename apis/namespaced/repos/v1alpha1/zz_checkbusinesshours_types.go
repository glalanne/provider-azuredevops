...
type CheckBusinessHoursInitParameters struct {
...
type CheckBusinessHoursObservation struct {
...
type CheckBusinessHoursParameters struct {
...
// CheckBusinessHoursSpec defines the desired state of CheckBusinessHours
type CheckBusinessHoursSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            CheckBusinessHoursParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CheckBusinessHoursInitParameters `json:"initProvider,omitempty"`
}

// CheckBusinessHoursStatus defines the observed state of CheckBusinessHours.
type CheckBusinessHoursStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CheckBusinessHoursObservation `json:"atProvider,omitempty"`
}
...
// CheckBusinessHours is the Schema for the CheckBusinessHourss API. Manages a business hours check.
...
type CheckBusinessHours struct {
	...
	Spec   CheckBusinessHoursSpec   `json:"spec"`
	Status CheckBusinessHoursStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CheckBusinessHoursList contains a list of CheckBusinessHourss
type CheckBusinessHoursList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CheckBusinessHours `json:"items"`
}

// Repository type metadata.
var (
	CheckBusinessHours_Kind             = "CheckBusinessHours"
	CheckBusinessHours_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CheckBusinessHours_Kind}.String()
	CheckBusinessHours_KindAPIVersion   = CheckBusinessHours_Kind + "." + CRDGroupVersion.String()
	CheckBusinessHours_GroupVersionKind = CRDGroupVersion.WithKind(CheckBusinessHours_Kind)
)

func init() {
	SchemeBuilder.Register(&CheckBusinessHours{}, &CheckBusinessHoursList{})
}
