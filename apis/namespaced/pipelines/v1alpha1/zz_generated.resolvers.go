...
func (mg *BuildDefinition) ResolveReferences( // ResolveReferences of this BuildDefinition.
	...
	if mg.Spec.ForProvider.Repository != nil {
		{
			m, l, err = apisresolver.GetManagedResource("serviceendpoint.azuredevops.m.crossplane.io", "v1alpha1", "ServiceendpointGithubEnterprise", "ServiceendpointGithubEnterpriseList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
