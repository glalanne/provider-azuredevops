...
type BuildDefinitionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	VariableGroupsRefs []v1.NamespacedReference `json:"variableGroupsRefs,omitempty" tf:"-"`

	// Selector for a list of VariableGroup in pipelines to populate variableGroups.
	// +kubebuilder:validation:Optional
	VariableGroupsSelector *v1.NamespacedSelector `json:"variableGroupsSelector,omitempty" tf:"-"`
}
...
type RepositoryInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-azuredevops/apis/namespaced/serviceendpoint/v1alpha1.ServiceendpointGithubEnterprise
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
