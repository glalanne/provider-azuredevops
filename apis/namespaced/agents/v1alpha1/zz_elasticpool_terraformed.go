...
func (mg *ElasticPool) GetTerraformResourceType() string {
	return "azuredevops_elastic_pool"
}
...
// GetInitParameters of this ElasticPool
func (tr *ElasticPool) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ElasticPool
func (tr *ElasticPool) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
