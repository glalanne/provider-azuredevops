...
func (mg *CheckApproval) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.ProjectIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("serviceendpoint.azuredevops.crossplane.io", "v1alpha1", "ServiceendpointGeneric", "ServiceendpointGenericList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *GitRepositoryBranch) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("repos.azuredevops.crossplane.io", "v1alpha1", "GitRepositoryBranch", "GitRepositoryBranchList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
