...
type ElasticPoolInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-azuredevops/apis/cluster/serviceendpoint/v1alpha1.ServiceendpointAzurerm
	...
	// +kubebuilder:validation:Optional
	ServiceEndpointScopeRef *v1.Reference `json:"serviceEndpointScopeRef,omitempty" tf:"-"`

	// Selector for a Project in project to populate serviceEndpointScope.
	// +kubebuilder:validation:Optional
	ServiceEndpointScopeSelector *v1.Selector `json:"serviceEndpointScopeSelector,omitempty" tf:"-"`
