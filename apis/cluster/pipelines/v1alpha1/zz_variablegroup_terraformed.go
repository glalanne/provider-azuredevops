...
// GetInitParameters of this VariableGroup
func (tr *VariableGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VariableGroup
func (tr *VariableGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
