...
//go:generate go run github.com/crossplane/upjet/v2/cmd/scraper -n microsoft/azuredevops -r ../.work/microsoft/azuredevops/website/docs/r -o ../config/provider-metadata.yaml
...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g azuredevops.crossplane.io -a github.com/glalanne/provider-azuredevops/internal/apis -o azuredevops.azuredevops.crossplane.io=azuredevops.crossplane.io -s -p ../apis/cluster/...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g azuredevops.m.crossplane.io -a github.com/glalanne/provider-azuredevops/internal/apis -o azuredevops.azuredevops.m.crossplane.io=azuredevops.m.crossplane.io -s -p ../apis/namespaced/...
