...
export TERRAFORM_PROVIDER_VERSION ?= 1.11.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-azuredevops
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/microsoft/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
