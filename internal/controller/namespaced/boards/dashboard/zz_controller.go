...
import (
	...
	v1alpha1 "github.com/glalanne/provider-azuredevops/apis/namespaced/boards/v1alpha1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginSDKAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["azuredevops_dashboard"],
